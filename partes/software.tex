...
Conforme ilustrado, o frontend atingiu 95,58\% de cobertura de comandos (\textit{Statements}), 88,40\% de ramos (\textit{Branches}), 94,11\% de funções (\textit{Functions}) e 97,09\% de linhas (\textit{Lines}). O diretório \texttt{models} obteve cobertura total (100\%), enquanto \texttt{services} alcançou 94,59\% e \texttt{view-models} 95,70\% em comandos. A cobertura de ramos em \texttt{services} (88,88\%) reflete a presença de tratamentos condicionais de erro que não foram todos exercitados nos testes.
...
\midrule
Frontend (Certificate Hub) & 11 & 108 & 95,58\% & 38,57\,s \\
Backend (Certificate Server) & 19 & 168 & 96,53\% & 14,86\,s \\
E2E (Playwright) & 1 & 1 & -- & 9,30\,s \\
\midrule
\textbf{Total} & \textbf{31} & \textbf{277} & \textbf{--} & \textbf{62,73\,s} \\
\bottomrule
\end{tabular}
\vspace{0.3em}

...
CT056 & Fluxo completo de emissão e validação & Usuário cria template, emite certificado e valida o código no portal público; todas as etapas são concluídas com sucesso. (Automatizado com Playwright.) & Executado \\

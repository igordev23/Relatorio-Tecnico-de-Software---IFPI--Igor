...
\item RF047 – Permitir configurar horários permitidos para emissão por perfil de colaborador.
\end{itemize}
...
\item RF054 – Validar vínculo do participante ao curso antes de permitir a emissão.

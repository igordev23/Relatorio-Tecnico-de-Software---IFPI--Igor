...
\draw (-0.5,-8.5) rectangle (16.5,5) node[above left, font=\small\bfseries, inner sep=3pt] at (16.5,5) {Sistema de Certificados};
...
\node[usecase, fill=yellow!30] (salvar) at (11,1.8) {Salvar};
\node[usecase, fill=yellow!30] (preview) at (14.5,0) {Prévia};
...
\node[usecase, fill=purple!25] (registro) at (13.5,-1.5) {Registrar};

\node[usecase, fill=purple!25] (fila) at (7.5,-3) {Fila};
\node[usecase, fill=purple!25] (notificar) at (11,-3) {Notificar};
\node[usecase, fill=purple!25] (email) at (13.5,-3) {Email};

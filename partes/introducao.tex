...
\begin{itemize}
    ...
    \item projetar e estruturar o fluxo de importação de dados a partir de arquivos CSV e Excel (.xlsx) para emissão em lote, com interface funcional e preparação da infraestrutura backend para processamento em fila;
    \item projetar e estruturar um módulo de notificação por e-mail com suporte a variáveis dinâmicas, incluindo a camada de frontend para agendamento e acompanhamento de envios;

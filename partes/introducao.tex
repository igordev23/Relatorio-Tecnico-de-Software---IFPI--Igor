...
\begin{itemize}
    ...
    \item desenvolver um módulo de dashboard com indicadores gerenciais, filtros por período, curso e status, e exportação de logs de auditoria;
    \item planejar e executar testes unitários e de integração para validação dos módulos implementados;
    \item configurar o ambiente de implantação do sistema em infraestrutura cloud utilizando conteinerização.
\end{itemize}

...
\begin{itemize}
    ...
    \item A \textbf{reemissão com manutenção de histórico} (\ref{rf:reemissao-historico}) não foi implementada — a edição de certificados sobrescreve os dados in-place, sem gerar novo código de verificação ou preservar a versão anterior, embora o requisito seja classificado como obrigatório;
